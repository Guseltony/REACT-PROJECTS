    ...
    return (
        <div className='w-[450px] min-h-[600px] border-2 border-amber-700 relative'>
            ...
            <div className='mb-8 flex items-center justify-center flex-col mt-4'>
                ...
                <p className='text-xs'>Get Organized and manage your time effectively</p>
            </div>


            {
                taskForm && 
                (<div className='flex flex-col justify-center items-center w-[100%] h-[100%] absolute top-0 left-0 bg-[#00000099] z-20'>
                    <ImCancelCircle
...

            {
                myTasks.map(({ text, id, completed }) => (
                    <div key={id}>
                        ...
                        {
                            (edittingId === id) ? <div className='border-2 border-green-500 px-4 py-4 flex items-center justify-between mt-4'>
                            ...
                            <div className={`${completed ? 'bg-gray-400' : 'bg-green-500'}  px-4 py-4 flex items-center justify-between mt-4`}>
                                ...
                                <div className='flex gap-2 '>
                                    <RiEdit2Fill size={25} color='#fff' onClick={() => editTask(id, text)} className='cursor-pointer' />
                                    <FaTrash size={25} color='#fff' onClick={() => deleteTask(id)} className='cursor-pointer' />
                                </div>
                            </div>
                        }
